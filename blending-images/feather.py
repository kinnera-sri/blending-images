...
cv2.imwrite("blending-images/result_images/warped_logo_feather_office_lego.png", warped_src)
cv2.imwrite("blending-images/result_images/warped_mask_feather_office_lego.png", warped_mask)
cv2.imwrite("blending-images/result_images/soft_mask_feather_office_lego.png", soft_mask)
cv2.imwrite("blending-images/result_images/feather_blended_office_lego.png", blended)
